...
contains(CHICOIN_NEED_QT_PLUGINS, 1) {
    DEFINES += CHICOIN_NEED_QT_PLUGINS
...
contains(CHICOIN_QT_TEST, 1) {
SOURCES += src/qt/test/test_main.cpp \
    src/qt/test/uritests.cpp
HEADERS += src/qt/test/uritests.h
DEPENDPATH += src/qt/test
QT += testlib
TARGET = chicoin-qt_test
DEFINES += CHICOIN_QT_TEST
