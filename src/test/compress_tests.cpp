...
// amounts 1 .. 10000
#define NUM_MULTIPLES_1CHI 10000

// amounts 50 .. 77000000
#define NUM_MULTIPLES_50CHI 1540000
...
BOOST_AUTO_TEST_CASE(compress_amounts)
{
    ...
    BOOST_CHECK(TestPair(77000000*COIN, 0x496ED40));
    ...
    for (uint64 i = 1; i <= NUM_MULTIPLES_1CHI; i++)
        BOOST_CHECK(TestEncode(i * COIN));

    for (uint64 i = 1; i <= NUM_MULTIPLES_50CHI; i++)
